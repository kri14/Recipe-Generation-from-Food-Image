...
data_dir = 'C:/Users/91991/Downloads/stream/'
...
def main():
    image = Image.open("C:/Users/91991/Downloads/stream/data/food_header.jpg").resize((680, 150))
    st.image(image)
    ...
    with st.sidebar:
        ...
        image = Image.open("C:/Users/91991/Downloads/stream/data/logo.png").resize((200, 90))
        with col1:
            st.write('')
        with col2:
            st.image(image)
